...
import { StyleSheet, View, Text, SafeAreaView, Image, Dimensions, FlatList, TouchableWithoutFeedback, ScrollView } from 'react-native';
        ...
        return (
            <SafeAreaView style={{flex:1, backgroundColor: '#fff'}}>
                <View style={styles.container}>
                    ...
                    <Text style={styles.redText}>Seleccione un grupo para seguir con la emision de su alerta</Text>
                    <Image style={styles.arrowImage} source={require('../assets/iconosFigma/redarrow.png')} />
                ...
                <View style={styles.groupSectionContainer}>
                    ...
                    <FlatList data={this.state.groups}
                        keyExtractor={item => item.fk_grupo.toString()} renderItem={({ item }) => (
                            <TouchableWithoutFeedback onPress={() => { this.sendAlertToGroupHandler(item.fk_grupo, item.nombre)}}>
                                <View style={styles.groupContainer}>
                                    <Image style={styles.groupIcon} source={require('../assets/iconosFigma/play-button.png')} />

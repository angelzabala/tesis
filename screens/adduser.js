...
export default class addUserComponent extends React.Component {
            ...
            return (
                 <View style={styles.fatherAnswareContainer}>
                    ...
                    <View style={styles.answareContainer}>
                        <Text>SÍ</Text>
                        <TouchableWithoutFeedback onPress={() => this.setState({funcionario: true})}>
                            <View style={styles.blueButton}></View>
                        </TouchableWithoutFeedback>
                        <Text>NO</Text>
                        <TouchableWithoutFeedback onPress={() => this.setState({funcionario: false})}>
    ...
    addUserHandler = () =>{
		...
		fetch(ipv4 + '/u-grupos/'+AsyncStorage.getItem('phone'), options).then((response) => {
    ...
    render() {
        return (
            <ScrollView style={{display: 'flex', paddingTop: 50, backgroundColor: "#fff"}}>
                <View style={styles.container}>
                    ...
                    <View style={styles.buttonContainer}>
						<TouchableWithoutFeedback style={styles.buttonContainer} onPress={() => {this.addUserHandler()}}>
							<Text style={{ width: screenWidth*0.6,color: "#fff", "backgroundColor": "#012133", textAlign: "center", "borderRadius": 25, padding: 10 }}>Agregar Usuario</Text>
						</TouchableWithoutFeedback>
					</View>
                </View>
            </ScrollView>

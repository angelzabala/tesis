...
import { StyleSheet, Image, View, Text, TouchableWithoutFeedback, Dimensions, AsyncStorage } from 'react-native';
...
export default function Header(props){
    ...
    const createGroupHandler = () => {
        props.navigation.navigate('createGroup'); //cambiar por crear grupo
    }
            ...
            <View style={styles.header}>
                <TouchableWithoutFeedback onPress={logOutHandler}>
                    <View style={styles.iconContainer}>
                        <Image style={styles.img} source={ require('../assets/iconosFigma/logout.png') } />
                        <Text style={styles.iconText}>Cerrar sesión</Text>
                    </View>
                </TouchableWithoutFeedback>
                <TouchableWithoutFeedback onPress={createGroupHandler}>
                    <View style={styles.iconContainer}>
                        <Image style={styles.img} source={ require('../assets/iconosFigma/plus.png') } />
            ...
            return ( 
                <View style={styles.oneIconHeader}>
                    <TouchableWithoutFeedback onPress={addUserHandler}>
                        <View style={styles.iconContainer}>
                            <Image style={styles.img} source={ require('../assets/iconosFigma/add.png') } />
